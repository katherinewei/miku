    ...
    function getUserLog(isRead,nicknameOrWxno){
        ...
        if(nicknameOrWxno){
         ...
         var  nexter = new Nexter({
            element: _wrap,
            dataSource: Data.getWxqrcodeLoginLogVOList,
        ...
        _wrap
            ...
            .on('click','.readUserLogBtn span.btn',function(){
                ...
                Data.readWxqrcodeLoginLog(data).done(function(){
                    ...
                    var badge = $('.badgegroup'),size = parseInt(badge.text()) - len;
                    if(size == 0){
                        badge.remove();
                    }
                    else{
            ...
            .off('click', '.checkbox').on('click', '.checkbox', function (event) {
                ...
                if($this.hasClass('active')){
                    ...
                    $('.checkBoxWrap .readUserLogBtn span').removeClass('btn');
                    ...
                    $('.checkBoxWrap .readUserLogBtn span').addClass('btn');
