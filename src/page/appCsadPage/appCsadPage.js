...
require([
    ...
    'h5/js/common/url',
    'h5/js/common/data',
    'h5/js/page/appCsadGroup',
    'h5/js/page/csadViewUserLog',
    'h5/js/page/csadPerformanceQuery',
    'h5/js/page/appCsadChatMessagePage',
    'h5/js/page/appCsadCommon',
    'h5/css/page/csadPage.css',
], function($,URL, Data,CsadGroup,ViewUserLog,PerformanceQuery,CsadChatMessagePage,CsadCommon)
{
    ...
    function init(){
        ...
        var template = '<header class="grid"><div class="headPicCol"><div id="headerimg" class="titleHeader" title="在线"><div class="headImg"> <div class="img-circle-50"><img id="myPic" /></div><span class="cur-online"></span></div><div id="login_user" class="login_user_title col"><p class="curName"> <a class="curName"></a></p><p class="wxno-user"></p></div></div></div><div class="callWrap row"><div class="call_title col" ><p>暂时没有用户呼叫！</p><ul id="call_title"></ul></div><div class="call_title_anonymous col" ><p>暂时没有匿名用户呼叫！</p><ul id="call_title_anonymous"></ul></div></div><div class="rightHead"><span class="addNewCsad" title="添加新专家"></span><span class="editCsad" title="编辑信息"></span></div> </header><div class="container grid"><div class="leftNav"><ul></ul><span id="logout"></span></div><div class="rightContainer"> <div class="wrap"><div class="wrapper"></div> </div> </div></div>';
    ...
    var showChatUI = function () {
        ...
        Data.fetchMineInfo().done(function(res){
            ...
            Data.checkIsExper(dataJudge).done(function(resu){
                ...
                //    setTimeout(function(){
                //        URL.assign(URL.loginPageCsad+'?refurl='+URL.appCsadPage);
                //    },2000)
                //
                //}
                //else{
                    ...
                    //保存当前专家的信息
                    var info = [res.nickName,res.mobile];
                    info = JSON.stringify(info);
                    sessionStorage.setItem('currentExpert',info);
    ...
    function bindEvent(){
        ...
        //导航选择
            ...
            .on('click','.leftNav li i',function(){
                ...
                if( name == 'chatMessage' ||  name == 'callCenter'){
                    CsadCommon.handleNav(parent);
                }
                if( name == 'performanceQuery'){
                    PerformanceQuery();
                }
                if(name == 'managementList' && _wrap.children().length == 0 ){
                    CsadGroup.group();
                }
