...
require([
    ...
    'h5/js/page/csadSelfInformation',
    'h5/js/page/csadDeliveryList',
], function($,URL, Data,CsadGroup,ViewUserLog,PerformanceQuery,SelfInformation,DeliveryList)
{
                   ...
                   var isExpert = resu.isExpert;
                    ...
                    //else{
                       ...
                       var wxno = res.wxno  ? res.wxno : '暂无';
                        ...
                        //保存当前专家的信息
                        var info = [res.nickName,res.mobile,res.profileId];
    ...
    function bindEvent(){
        ...
        //导航选择
            ...
            .on('click','.leftNav li i',function(){
                ...
                if( name == 'performanceQuery'){  //业绩
                    PerformanceQuery();
                }
                if( name == 'deliveryList'){//延迟订单
                    DeliveryList();
                }

                else if( name == 'selfInformation' && _wrap.children().length == 0){//个人微信
                    SelfInformation();
                }
                else{
                    _wrap.show();
